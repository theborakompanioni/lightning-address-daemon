...
The [issue tracker](https://github.com/theborakompanioni/lightning-address-daemon/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/lna.git
   # Navigate to the newly cloned directory
   cd lna
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/theborakompanioni/lightning-address-daemon.git
   ```
